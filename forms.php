        ...
        <section class="section main-section">
            <div class="card mb-6">
                ...
                <div class="card-content">
                    <form method="POST" action="insertForm.php"enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="number" placeholder="Contract_number" name="c_number" style="width: auto;">
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contract_title" name="c_title" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contractor" name="c_client" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contract partner" name="c_partner" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contract_Sp" name="c_sp" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="number" placeholder="Contract_Amount" name="c_amount" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contract_Duration" name="c_duration" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="text" placeholder="Contract_Manager" name="c_manager" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
                                ...
                                <td>
                                    <div class="field">
                                        ...
                                        <div class="field-body">
                                            <div class="field">
                                                <div class="control icons-left">
                                                    <input class="input" type="date" placeholder="" name="c_date" style="width: auto;">
                                                    <span class="icon left"><i class="mdi mdi-account"></i></span>
                                                    <p class="help">
                                                        This field is required
                                                    </p>
